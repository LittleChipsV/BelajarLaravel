...
<form action="/topik/{{ $topik->id }}" method="POST">
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group">
            ...
            <input autofocus required type="text" name='nama_topik' value="{{ $topik->nama_topik }}" id="nama-topik" class="form-control @error('nama_topik')is-invalid @enderror" placeholder="Masukkan nama topik">
            @error('nama_topik')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
